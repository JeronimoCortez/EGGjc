...
public class servicioMesSecreto {
   ...
   public void adivinar(){
     ...
     while(cont > 0 && !m1.getMesCorrecto().equals(mesUsuario)){
         System.out.println("INCORRECTO intente nuevamente"); 
         mesUsuario = leer.nextLine();
     }
     if(m1.getMesCorrecto().equals(mesUsuario)){
         System.out.println("CORRECTO EL MES SECRETO ES: " + m1.getMesCorrecto().toUpperCase()+ "!!!!!"); 
     }
      }
}
